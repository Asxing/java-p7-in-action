...
public class SqlInjectController {
    ...
    public void init() {
        ...
        jdbcTemplate.execute(
                "INSERT INTO `userdata` (name,password) VALUES ('test1','haha1'),('test2','haha2')");
    }
    ...
    public void jdbcwrong(@RequestParam("name") String name) {
        ...
        // --current-db --flush-session
        // python sqlmap.py -u  http://localhost:45678/sqlinject/jdbcwrong --data name=test --tables
        // -D "common_mistakes"
        // python sqlmap.py -u  http://localhost:45678/sqlinject/jdbcwrong --data name=test -D
        // "common_mistakes" -T "userdata" --dump
        log.info(
                "{}",
                jdbcTemplate.queryForList(
                        "SELECT id,name FROM userdata WHERE name LIKE '%" + name + "%'"));
    }
    ...
    public List mybatiswrong(@RequestParam("name") String name) {
        ...
        // python sqlmap.py -u  http://localhost:45678/sqlinject/mybatiswrong --data name=test
        // --current-db --flush-session
    ...
    public List mybatiswrong2(@RequestParam("names") String names) {
        ...
        // python sqlmap.py -u  http://localhost:45678/sqlinject/mybatiswrong2 --data
        // names="'test1','test2'"

...
public class OrderController {
    ...
    public void createOrder(
            @RequestParam("userId") long userId, @RequestParam("merchantId") long merchantId) {
        ...
        try {
            ...
            if (userId < 10) throw new RuntimeException("invalid user");
            // 查询商户服务
            Boolean merchantStatus =
                    restTemplate.getForObject(
                            "http://localhost:45678/order/getMerchantStatus?merchantId="
                                    + merchantId,
                            Boolean.class);
            ...
            Metrics.timer("createOrder.failed", "reason", ex.getMessage())
    ...
    public boolean getMerchantStatus(@RequestParam("merchantId") long merchantId)

...
public class CommonMistakesApplication {
    ...
    private void initMySQL() {
                ...
                new BatchPreparedStatementSetter() {
                    ...
                    public void setValues(PreparedStatement preparedStatement, int i)
                        ...
                        preparedStatement.setTimestamp(
                                2, Timestamp.valueOf(LocalDateTime.now().minusSeconds(5 * i)));
                    }
        ...
        log.info(
                "init mysql finished with count {} took {}ms",
                jdbcTemplate.queryForObject("SELECT COUNT(*) FROM `m`", Long.class),
    ...
    private void initInfluxDB() {
        ...
        try (InfluxDB influxDB =
            ...
            influxDB.flush();
            log.info(
                    "init influxdb finished with count {} took {}ms",

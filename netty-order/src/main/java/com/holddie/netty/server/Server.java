package com.holddie.netty.server;

import com.holddie.netty.server.codec.OrderFrameDecoder;
import com.holddie.netty.server.codec.OrderFrameEncoder;
import com.holddie.netty.server.codec.OrderProtocolDecoder;
import com.holddie.netty.server.codec.OrderProtocolEncoder;
import com.holddie.netty.server.handler.AuthHandler;
import com.holddie.netty.server.handler.MetricsHandler;
import com.holddie.netty.server.handler.OrderServerProcessHandler;
import com.holddie.netty.server.handler.ServerIdleCheckHandler;
        ...
        try {
            ...
            GlobalTrafficShapingHandler globalTrafficShapingHandler =
                    new GlobalTrafficShapingHandler(
                            eventLoopGroupForTrafficShaping, 10 * 1024 * 1024, 10 * 1024 * 1024);

            // ipfilter
            IpSubnetFilterRule ipSubnetFilterRule =
                    new IpSubnetFilterRule("127.1.1.1", 16, IpFilterRuleType.REJECT);
            ...
            serverBootstrap.childHandler(
                    new ChannelInitializer<NioSocketChannel>() {
                        ...
                        protected void initChannel(NioSocketChannel ch) throws Exception {
                            ...
                            pipeline.addLast(
                                    "flushEnhance", new FlushConsolidationHandler(10, true));
